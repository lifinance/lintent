export const COIN_FILLER_ABI = [
	{
		...
		inputs: [{ name: "proofSeries", type: "bytes", internalType: "bytes" }],
		outputs: [],
	...
	},
	{
		...
		inputs: [
			...
			{ name: "fillDeadline", type: "uint48", internalType: "uint48" },
			{ name: "fillerData", type: "bytes", internalType: "bytes" }
		],
		outputs: [{ name: "fillRecordHash", type: "bytes32", internalType: "bytes32" }],
	...
	},
	{
		type: "function",
		name: "hasAttested",
		inputs: [{ name: "payloads", type: "bytes[]", internalType: "bytes[]" }],
		outputs: [{ name: "accumulator", type: "bool", internalType: "bool" }],
		stateMutability: "view"
	},
	{
		type: "function",
	...
	},
	{
		...
		inputs: [
			...
			{ name: "solver", type: "bytes32", indexed: false, internalType: "bytes32" },
	...
	{ type: "error", name: "CallOutOfRange", inputs: [] },
	{ type: "error", name: "ContextOutOfRange", inputs: [] },
	{ type: "error", name: "FailedCall", inputs: [] },
	{ type: "error", name: "FillDeadline", inputs: [] },
	{ type: "error", name: "HasDirtyBits", inputs: [] },
	{
		type: "error",
	...
	},
	{
		...
		inputs: [
			{ name: "storedFillRecordHash", type: "bytes32", internalType: "bytes32" },
			{ name: "givenFillRecordHash", type: "bytes32", internalType: "bytes32" }
		]
	},
	{
		type: "error",
		...
		inputs: [
			...
			{ name: "divisor", type: "uint256", internalType: "uint256" }
		]
	},
	{ type: "error", name: "NotProven", inputs: [] },
	{ type: "error", name: "PayloadTooSmall", inputs: [] },
	{
		type: "error",
