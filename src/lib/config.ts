...
export const SOLANA_DEVNET_INTENTS_PROTOCOL = SOLANA_PROGRAMS.devnet.INTENTS_PROTOCOL;
export const SOLANA_DEVNET_OUTPUT_SETTLER_SIMPLE = SOLANA_PROGRAMS.devnet.OUTPUT_SETTLER_SIMPLE;
export const SOLANA_DEVNET_INPUT_SETTLER_ESCROW = SOLANA_PROGRAMS.devnet.INPUT_SETTLER_ESCROW;
export const SOLANA_DEVNET_POLYMER_ORACLE = SOLANA_PROGRAMS.devnet.POLYMER_ORACLE;
export const SOLANA_DEVNET_POLYMER_PROVER_PROGRAM = SOLANA_PROGRAMS.devnet.POLYMER_PROVER;
export const SOLANA_DEVNET_OUTPUT_SETTLER_PDA = SOLANA_PDAS.devnet.OUTPUT_SETTLER;
